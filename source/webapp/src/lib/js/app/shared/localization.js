    ...
    return {
      'en-US': {
        Messages: {
          ...
          HighlightTabDesc: 'Detect highlight-worthy segments in this video using a Bedrock model. Each detection run produces a <em>HighlightSet</em> that you can review and (later) edit into a final cut.',
          HighlightSetsTitle: 'Highlight sets generated for this video',
          HighlightSetsEmpty: 'No highlight sets yet. Click <strong>Detect highlights</strong> below to generate the first set.',
          HighlightDetectTitle: 'Detect highlights',
          HighlightStrategy: 'Strategy',
          HighlightStrategyAuto: 'Auto (decide by speech density)',
          HighlightStrategyTranscript: 'Transcript-based (LLM)',
          HighlightStrategyVlm: 'Video + transcript (multimodal)',
          HighlightModel: 'Model',
          HighlightDefaultModel: 'Default (settings)',
          HighlightCustomPrompt: 'Custom prompt (optional)',
          HighlightMaxSegments: 'Max segments',
          // Highlight editor
          HighlightEditorTitle: 'Highlight editor',
          HighlightEditorSourceTrack: 'Timeline',
          HighlightEditorAutoTrack: 'Auto-highlights',
          HighlightEditorEditTrack: 'Edit',
          HighlightEditorInspector: 'Inspector',
          HighlightEditorEmptyEdit: 'Edit track is empty. Drop segments here from the auto-highlights track or add a custom segment from the playhead.',
          HighlightEditorAddCustom: 'Add custom segment from playhead',
          HighlightEditorPublishLabel: 'Publish to library after rendering',
          HighlightEditorAspectRatio: 'Aspect ratio',
          HighlightEditorBurnCaptions: 'Burn-in captions',
          HighlightEditorIn: 'Set In',
          HighlightEditorOut: 'Set Out',
          HighlightEditorDrop: 'Drop',
          HighlightEditorRestore: 'Restore',
          HighlightEditorRemove: 'Remove',
          HighlightEditorMoveUp: 'Up',
          HighlightEditorMoveDown: 'Down',
        },
        Tooltips: {
          /* main view */
          ...
          HighlightStrategy: 'Detection strategy. \'Transcript-based\' picks moments from speech (text models). \'Video + transcript\' sends the proxy MP4 to a video-capable model alongside any available transcript — works for videos with or without speech. \'Auto\' picks per asset.',
          HighlightModelTooltip: 'Bedrock model used for the detection. Video-capable models are listed for Video + transcript / Auto; text models for Transcript-based. Choose \'Default\' to use the model from your highlight settings.',
          ...
          ViewHighlightSet: 'View this highlight set',
          OpenHighlightEditor: 'Open this highlight set in the editor to trim, reorder, and add custom segments before rendering.',
          DeleteHighlightSet: 'Delete this highlight set permanently. Edit projects that reference it will keep their copy of the segments.',
        },
        Buttons: {
          Back: 'Back',
          Next: 'Next',
          ...
          ViewHighlightSet: 'View segments',
          OpenHighlightEditor: 'Open in editor',
          DeleteHighlightSet: 'Delete',
          SaveHighlightEdit: 'Save edit',
          CloseHighlightEditor: 'Close',
          RenderAndPublish: 'Render',
        },
        Statuses: {
        ...
        Alerts: {
          ...
          // highlight
          HighlightDetectionStarted: 'Highlight detection started. The new highlight set will appear here when the workflow completes.',
          HighlightDetectionFailed: 'Failed to start highlight detection. {{ERROR}}',
          NoHighlightTranscript: 'This video does not have a completed transcript yet. Highlight detection requires the transcribe step to be done.',
          NoHighlightSets: 'No highlight sets generated yet for this video.',
          HighlightEditSaved: 'Edit saved.',
          HighlightEditSaveFailed: 'Failed to save edit. {{ERROR}}',
          HighlightEditLoadFailed: 'Failed to load edit project. {{ERROR}}',
          HighlightEditEmptyEdit: 'Edit track is empty. Add at least one segment before saving.',
          HighlightRenderQueued: 'Render queued. You can close this dialog — progress will continue in the background.',
          HighlightRenderFailed: 'Failed to start render. {{ERROR}}',
        },
      },
    };
  }
