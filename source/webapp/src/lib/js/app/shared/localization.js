    ...
    return {
      'en-US': {
        Messages: {
          ...
          HighlightEditorSourceTrack: 'Source',
        ...
        Tooltips: {
          ...
          HighlightStrategy: 'Detection strategy. \'Auto\' lets the model choose; the others bias the prompt.',
          HighlightModelTooltip: 'Bedrock model used for the detection. Choose \'Default\' to use the model from your highlight settings.',
        ...
        Buttons: {
          ...
          RenderAndPublish: 'Render & Publish',
        },
        Statuses: {
