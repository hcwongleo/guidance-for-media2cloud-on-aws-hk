    ...
    return {
      'en-US': {
        ...
        Tooltips: {
          ...
          HighlightMaxSegmentsTooltip: 'Runaway ceiling — if the model exceeds it, only the highest-confidence picks are kept. Default 30.',
          HighlightMinConfidenceTooltip: 'Primary quality filter (0.0–1.0). Only segments scoring at or above this value are kept. Default 0.7. Lower it if you want more (lower-quality) picks; raise it to be more selective.',
